...
INSERT INTO `contactus` VALUES (1,'Shubham Sahane','shubhamsahane2710@gmail.com','Have a serious talk ','I have Some Issue With My Login'),(3,'Shubham Sahane','shubhamsahane2710@gmail.com','Have a serious talk ','qdwdwd'),(4,'Shubham Sahane','alumni@gmail.com','Have a serious talk ','qww'),(5,'Shubham Sanjay Sahane','shubhamsahane27@gmail.com','Need Help for Alumni registration !!','I Am alumni of the institute and in want to register my email in system.');
...
INSERT INTO `session_details` VALUES (9,'Webinar on Python','We Will Check Some CRUD Operations With python Django.','08/01/2023 : 17:00','Shubham    Sahane',9,'https://www.example.com'),(11,'Webinar on Css','hello everyonewe are arranging webinar on CSS','08/23/2023 : 01:50','Shubham  Sahane',14,'https://www.example.com'),(12,'Webinar on Python','abcs','08/02/2023 : 14:27','Shubham  Sahane',14,'https://www.example.com');
...
CREATE TABLE `session_join_list` (
  ...
  PRIMARY KEY (`id`),
  KEY `studenr_idx` (`student_id`),
  KEY `sessionf_idx` (`session_id`),
  CONSTRAINT `sessionf` FOREIGN KEY (`session_id`) REFERENCES `session_details` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `studentf` FOREIGN KEY (`student_id`) REFERENCES `user_details` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `session_join_list` VALUES (10,9,13),(11,11,13);
...
INSERT INTO `student_db` VALUES (1,'Shubham','Sahane','chaitanya@gmail.com','2023-2024','NA','+918552804872'),(9,'Roshan','Muneshwar','roshanmuneshwar143@gmail.com','2022-2023','na','+91 9309887572'),(11,'Shubham ','Sahane','student@gmail.com','2023-2024','NA','+918552804872'),(12,'Shubham ','Sahane','alumni@gmail.com','2023-2024','NA','+918552804872'),(13,'Harshada','Chaudhari','harshuchaudhari0120@gmail.com','2023-2024','NA','+918552804872'),(14,'Pooja ','Jadhav','poojajadhav@gmail.com','2022-2023','NA','+918552804872');
...
INSERT INTO `subscribe` VALUES (1,'test@gmail.com'),(2,'shubhamsahane2710@gmail.com'),(3,'shubhamsahane.pentagonspace@gmail.com'),(4,'shubhamsahane27@gmail.com');
...
-- Dump completed on 2023-08-22 16:49:47
